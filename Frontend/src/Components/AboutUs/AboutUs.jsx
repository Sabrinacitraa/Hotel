...
const aboutUs = () => {
  ...
  const images = [
    { src: img1, text1: 'Kuta, Bali', text2: 'Jl. Benesari, Kuta, Kuta, Badung' },
    { src: img2, text1: 'Seminyak, Bali', text2: 'Jl. Petitenget Gang Cendrawasih No.99, Kerobokan Kelod, Kuta Utara, Badung' },
    { src: img3, text1: 'Ungasan, Bali', text2: 'Jl. Raya Uluwatu, Ungasan, Kuta Selatan, Badung' },
    { src: img4, text1: 'Balikpapan', text2: 'Jl. Pelita No.19, Sepinggan, Balikpapan Selatan, Balikpapan' },
    { src: img5, text1: 'Bandung', text2: 'Jl. Ir. H. Juanda No.46, Citarum, Bandung Wetan, Bandung' },
    { src: img6, text1: 'Jakarta Thamrin', text2: 'Jl. M.H. Thamrin Kav 9, Gondangdia, Menteng, Jakarta Pusat' },
    { src: img7, text1: 'Makassar', text2: 'Jl. Andi Djemma No.130, Banta-Bantaeng, Rappocini, Makassar' },
    { src: img8, text1: 'Manado', text2: 'Jl. Piere Tendean, Sario Tumpaan, Sario, Manado' },
    { src: img9, text1: 'Medan', text2: 'Jl. Gatot Subroto No.395, Sei Sikambing D, Medan Petisah, Medan' },
    { src: img10, text1: 'Pakuwon Indah, Surabaya', text2: 'Jl. Raya Lontar No.2, Babatan, Wiyung, Surabaya' },
    { src: img11, text1: 'Tunjungan Plaza, Surabaya', text2: 'Jl. Embong Malang No.25-31, Kedungdoro, Tegalsari, Surabaya' },
  ];

  return (
    <section className='about'>
    <div className="text">
      <h1>Step into a world of timeless elegance where modern amenities seamlessly merge with classic charm, offering guests an unparalleled retreat.</h1>
      <p>Nestled in the heart of the city, our
       hotel is a testament to refined elegance and unparalleled hospitality. With a commitment to providing an exceptional stay, we blend modern comfort seamlessly with timeless charm. </p>
    </div>
    <div className="image">
    ...
    <div className="loop">
        {images.map((image, index) => (
          <div key={index} className="image-description">
            <img src={image.src} alt={`image ${index}`} style={{ width: '100%' }} />
